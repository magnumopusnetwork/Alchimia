...
space *do not upload these to the alchimia.org server, nor put them in the torrent*.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the alchimia.org server.

```

- Update alchimia.org version

- Announce the release:

  - alchimia-dev and alchimia-dev mailing list

  - blog.alchimia.org blog post
