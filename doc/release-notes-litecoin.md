Alchimia Core version *0.15.1* is now available from:

  <https://download.magnumopusnetwork.com/alchimia-0.15.1/>
...
A number of changes to the way Alchimia Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 AGs per kB (0.00001 ALK). This is to prepare for dropping the minimum transaction fee to 0.1 AGs per kB (0.0001 ALK) in the next release.
