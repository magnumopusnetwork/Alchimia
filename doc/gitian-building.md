...
Output from `gbuild` will look something like
    ...
    From https://github.com/alchimia-project/alchimia
...
[alchimia-project/gitian.sigs.ltc](https://github.com/alchimia-project/gitian.sigs.ltc/) repository, or if that's not possible create a pull
