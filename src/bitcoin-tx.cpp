...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s alchimia-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  alchimia-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded alchimia transaction") + "\n" +
              "  alchimia-tx [options] -create [commands]   " + _("Create hex-encoded alchimia transaction") + "\n" +
              "\n";
