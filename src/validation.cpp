...
#if defined(NDEBUG)
# error "Alchimia cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Alchimia Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s ALK additional fees, %d delta bytes\n",
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
    ...
    */
    ...
    CAmount nSubsidy = 1000000 * COIN; // 1,000,000
