    ...
    transactionView(0), abandonAction(0), bumpFeeAction(0), columnResizingFixer(0)
{
    ...
    QImage imgEyePlus(":/icons/eye_plus");
    watchOnlyWidget->addItem(QIcon(QPixmap::fromImage(imgEyePlus)), "", TransactionFilterProxy::WatchOnlyFilter_Yes);
    QImage imgEyeMinus(":/icons/eye_minus");
    watchOnlyWidget->addItem(QIcon(QPixmap::fromImage(imgEyeMinus)), "", TransactionFilterProxy::WatchOnlyFilter_No);
